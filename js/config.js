...
const UI = {
    ...
    renderSidebar: (activeLink = '') => {
        ...
        if (role === 'STUDENT') {
            ...
            links = [
                { href: 'admin_dashboard.html', icon: 'fa-chart-simple', text: 'Overview' },
                { href: 'admin_dashboard.html', icon: 'fa-list-check', text: 'Registry' },
                { href: 'admin_dashboard.html', icon: 'fa-user-group', text: 'Identities' },
                { href: 'profile.html', icon: 'fa-user-circle', text: 'Admin Profile' }
            ];
        } else if (role === 'STAFF') {
            links = [
        ...
        nav.innerHTML = links.map(link => {
            ...
            const switchTarget = link.text.toLowerCase() === 'overview' ? 'dashboard' : 
                               link.text.toLowerCase() === 'registry' ? 'complaints' : 
                               link.text.toLowerCase() === 'identities' ? 'users' : '';
